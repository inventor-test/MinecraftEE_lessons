...
```
## Step 8
За допомогою свистка розмістіть агента десь **на вході, біля дороги**.
...
## Step 10
Виконайте цю програму для другої частини воріт. Розмістіть агента з **іншої сторони входу** (дороги) і запустіть команду ще раз. Тепер у вас має бути два дерев'яних стовпи для входу.  
